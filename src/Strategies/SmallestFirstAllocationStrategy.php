...
/**
 * Smallest first allocation strategy.
 *
 * Allocates payment to documents with smallest outstanding balances first.
 * This strategy maximizes the number of fully paid documents.
 */
final class SmallestFirstAllocationStrategy extends AbstractAllocationStrategy
{
    public function getMethod(): AllocationMethod
    {
        return AllocationMethod::SMALLEST_FIRST;
    }
    ...
    /**
     * Sort documents by outstanding balance (smallest first).
     *
     * @param array<AllocatableDocumentInterface> $documents
